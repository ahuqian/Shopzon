...
class LoginController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Home.login',['friend' => $friend,'deploy' => $deploy]);
    }
    ...
    public function doindex()
    {
        $friend = DB::table('friend')->get();
        $deploy = DB::table('deploy')->get();
        return view('Home.register',['friend' => $friend,'deploy' => $deploy]);
    }
    //验证码
       ...
       // $mycode = session('mycode');
        ...
        if($ob){
            ...
            if($ob->home_pass == $password){
                ...
                // dd(session('alluser'));
                // exit;
                return redirect("/home/demo")->with('msg','登录成功...跳转首页');
            }else{   
    ...
    public function over()
    {
        ...
        return redirect('/home/demo')->with('msg','退出！');
    }
}
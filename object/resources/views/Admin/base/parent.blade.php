            ...
            <aside id="sidebar">
                ...
                <ul class="list-unstyled side-menu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="list-unstyled menu-item">
                            <li><a href="/admin/demo5">显示商品信息</a></li>
                            <li><a href="/admin/demo5/create">添加商品</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a class="sa-side-form" href="">
                        ...
                        <ul class="list-unstyled menu-item">
                            <li><a href="/admin/type">显示商品类别</a></li>
                            <li><a href="/admin/type/create">添加商品类别</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a class="sa-side-form" href="">
                        ...
                        <ul class="list-unstyled menu-item">
                            <li><a href="/admin/orderlist">显示订单</a></li>
                            <li><a href="/admin/orderlist/create">添加订单</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a class="sa-side-form" href="">
                        ...
                        <ul class="list-unstyled menu-item">
                            <li><a href="/admin/carousel">显示轮播图</a></li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="list-unstyled menu-item">
                            <li><a href="/admin/friend">显示友情链接信息</a></li>
                            <li><a href="/admin/friend/create">添加链接</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a class="sa-side-form" href="">
                        ...
                        <ul class="list-unstyled menu-item">
                            <li><a href="/admin/store">显示评论信息</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a class="sa-side-form" href="">
                        ...
                        <ul class="list-unstyled menu-item">
                            <li><a href="/admin/cart">显示购物车信息</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a class="sa-side-form" href="">
                        ...
                        <ul class="list-unstyled menu-item">
                            <li><a href="/admin/deploy">显示网站配置信息</a></li>
                            <li><a href="/admin/deploy/create">添加网站配置方式</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a class="sa-side-form" href="">
                            <span class="menu-item">前台用户管理</span>
                        </a>
                        <ul class="list-unstyled menu-item">
                            <li><a href="/admin/home_user">显示前台用户信息</a></li>
                            <li><a href="/admin/home_user/create">添加前台用户</a></li>
                        </ul>
                    </li>
                </ul>

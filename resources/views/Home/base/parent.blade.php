					...
					<div class="row">
						<div class="col-md-3 col-sm-12">
							...
							<div class="logo-area text-center text-uppercase">
								<a href="index.html"><img src="{{ asset('Admin/upload/deployimg').'/'.$v->logo }}" width='234' height='80' alt="" /></a>
							</div>
							@endforeach
						</div>
							...
							<div class="main-menu lemon-bg">
								<nav>
									<ul id="nav">
										...
										<li><a href="shop.html">商品分类</a>
											<ul>
												<li><a href="shop.html"><i class="arrow_carrot-right"></i>口红</a>
												</li>
												<li><a href="shop-grid.html"><i class="arrow_carrot-right"></i>BB霜</a></li>
												<li><a href="shop-list.html"><i class="arrow_carrot-right"></i>卸妆水</a></li>
												<li><a href="single-product.html"><i class="arrow_carrot-right"></i>香水香氛</a></li>
												<li><a href="single-product.html"><i class="arrow_carrot-right"></i>个人护理</a></li>
											</ul>
										</li>
										@if(!empty(session('alluser')->home_name))
											<li><a href="#">个人中心</a>
												<ul>
													...
													<li><a href="account.html"><i class="arrow_carrot-right"></i>我的订单</a></li>
												</ul>
											</li>
											<li>
									...
									<div class="top-cart-content">
										...
										<div class="media header-middle-checkout">
											<div class="media-left check-img">
												<a href="#">
													<img alt="" src="{{ asset('/home/img/other/cart-1.jpg') }}">
												</a>
											</div>
										...
										<div class="media header-middle-checkout">
											<div class="media-left check-img">
												<a href="#">
													<img alt="" src="{{ asset('/home/img/other/cart-2.jpg') }}">
												</a>
											</div>
											<div class="media-body checkout-content">
												<h4 class="media-heading">
					...
					<div class="row">
						...
						<div class="col-md-3 col-sm-4 col-xs-12">
							<div class="footer-menu res-mb-sm-30">
								...
								<ul>
									...
									<li><a href="#">支付</a></li>
									<li><a href="{{ url('/home/myorder') }}">追踪您的订单</a></li>
									<li><a href="#">返回</a></li>
									<li><a href="#">保证</a></li>
								</ul>
							</div>
						...
						<div class="col-md-3 hidden-sm hidden-xs">
							<div class="footer-menu">
								...
								<ul>
									@foreach($ob as $v)
									<li><a href="http://{{ $v->furl }}">{{ $v->fname }}</a></li>
									@endforeach

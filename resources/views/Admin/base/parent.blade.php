            ...
            <aside id="sidebar">
                ...
                <ul class="list-unstyled side-menu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="list-unstyled menu-item">
                            <li><a href="/admin/cllect">显示收藏信息</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a class="sa-side-form" href="">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="list-unstyled menu-item">
                            <li><a href="/admin/sitelist">显示地址信息</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a class="sa-side-form" href="">
                    ...
                    <li class="dropdown">
                        <a class="sa-side-form" href="">
                            <span class="menu-item">配送方式管理</span>
                        </a>
                        <ul class="list-unstyled menu-item">
                            <li><a href="/admin/delivery">显示配送方式信息</a></li>
                            <li><a href="/admin/delivery/create">添加配送方式</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a class="sa-side-form" href="">
